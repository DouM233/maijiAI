...
export function getPrototypeTemplate() {
  ...
  return {
    appShell: extractBlock(indexHtml, /<main class="app-shell">[\s\S]*<\/main>/, "appShell"),
    ...
    agentsScript: readFile(path.join("data", "agents.js")),
    toolLinksScript: readFile(path.join("data", "tool-links.js")),
